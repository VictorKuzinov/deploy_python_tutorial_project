...
WHERE "shopapp_productimage"."product_id" = 5;

SELECT "django_session"."session_key", "django_session"."session_data", "django_session"."expire_date"
FROM "django_session"
WHERE ("django_session"."expire_date" > '2026-01-26 04:10:43.782612' AND
       "django_session"."session_key" = '1igxbfc3bb3p27rvmxqrfzitq7rr201o') LIMIT 21;
...
SELECT "django_session"."session_key", "django_session"."session_data", "django_session"."expire_date"
FROM "django_session"
WHERE ("django_session"."expire_date" > '2026-01-26 04:28:07.716316' AND
       "django_session"."session_key" = '1igxbfc3bb3p27rvmxqrfzitq7rr201o') LIMIT 21;
